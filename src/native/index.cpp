...
Napi::Value HelloWorld(const Napi::CallbackInfo& info) {
  ...
  if (emoji_generate(&params, &result) != EG_OK) {
      emoji_free(&result);
      Napi::TypeError::New(env, "Failed to create emoji").ThrowAsJavaScriptException();
...
Napi::Object Init(Napi::Env env, Napi::Object exports) {
  ...
  exports.Set(Napi::String::New(env, "createObj"), Napi::Function::New(env, CreateObj));
  exports.Set(Napi::String::New(env, "getArgs"), Napi::Function::New(env, GetArgs));
